...
df_transformed = df_clean.withColumn("total_amount", col("price") * col("quantity"))
...
os.makedirs("data/curated/category_revenue", exist_ok=True)
os.makedirs("data/curated/top_products", exist_ok=True)
os.makedirs("data/curated/avg_transaction", exist_ok=True)
...
os.makedirs("data/clean/partitioned_by_category", exist_ok=True)
